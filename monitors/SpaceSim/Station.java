...
public class Station{ 
    ...
    public void request_fuel(int requested_N, int requesed_Q){
        ...
        synchronized(this){
            while( V_available == 0 || requested_N > N_available || requesed_Q > Q_available){
                try {
                    wait();
            ...
            System.out.println("Thread " + Thread.currentThread().getName() + " has recieved " + requested_N + " Nitrogen and " + requesed_Q + " quantum fuel");
        }
        try {
    ...
    public synchronized void leave_station(){
            ...
            V_available++;
            notifyAll();
            System.out.println("Thread " + Thread.currentThread().getName() + " has left the station");
    ...
    public synchronized void refuel_station(int N_supplied, int Q_supplied){
            ...
            System.out.println("Supply thread " + Thread.currentThread().getName() + " has supplied " + N_supplied + " Nitrogen and " + Q_supplied + " quantum fuel");
            notifyAll();
            leave_station();
